...
<template>
    <section class="mb-5">
        ...
        <!-- Modal -->
        <div class="modal fade show d-block" v-if="confirmingUserDeletion" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" :class="{ 'disabled': form.processing }"
